...
... al.のSR-Inverse[^1^](jmanual.html#tex2html1)
...
... CLASS="MATH"\>**![$ \\theta$](jmanual-img17.png)**![$
)$](jmanual-img34.png)[^2^](jmanual.html#tex2html2)
  ~ ロボットアームの可操作度, 吉川恒夫, 日本ロボット学会誌, vol. 2, no.
    1, pp. 63-67, 1984.
...
... タスク空間次元の選択行列[^3^](jmanual.html#tex2html3)
...
... 基礎ヤコビ行列[^4^](jmanual.html#tex2html4)
...
... 本節では,文献[^5^](jmanual.html#tex2html5)
...
...5[^6^](jmanual.html#tex2html6)
  ~ A weighted least-norm solution based scheme for avoiding jointlimits
    for redundant joint manipulators, Tan Fung Chan and Dubey R.V.,
    Robotics and Automation, IEEE Transactions on, pp. 286-292,1995
...
...
により提案されている効率的な衝突回避計算[^8^](jmanual.html#tex2html8)
...
... Package)[^10^](jmanual.html#tex2html10)
  ~ Fast distance queries with rectangular swept sphere volumes, Larsen
    ...
    International Conference on Robotics and Automation, pp. 3719-3726,
    2000.
...
... アーム・多指ハンドの動作生成[^11^](jmanual.html#tex2html13)
...
... 宇宙ロボット[^12^](jmanual.html#tex2html14)
  ~ 一般化ヤコビ行列を用いた宇宙用ロボットマニピュレータの分解速度制御,
    梅谷 陽二, 吉田 和哉, 日本ロボット学会誌, vol. 4, no. 7, pp. 63-73,
    1989.
...
...
環境に固定されないヒューマノイドロボット[^13^](jmanual.html#tex2html15)
...
... 実際には再帰計算により計算する[^14^](jmanual.html#tex2html17)
